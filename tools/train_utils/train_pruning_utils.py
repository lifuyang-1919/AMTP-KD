...
def train_pruning_model(model, optimizer, train_loader, optim_cfg, start_epoch, total_epochs, ckpt_save_dir, Random=None, prunratio=None):
    ...
    from tools.train_utils.sliming_pruning import sliming_pru
    model = sliming_pru(model, batch, Random, prunratio)

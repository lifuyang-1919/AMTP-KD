...
class Detector3DTemplate(nn.Module):
    ...
    def build_networks(self):
        model_info_dict = {
            ...
            'voxel_size': (
                self.dataset.voxel_size_tea2 if hasattr(self.dataset, 'voxel_size_tea2') and self.model_cfg.get(
                    'IS_TEACHER', None)
                else self.dataset.voxel_size_tea if hasattr(self.dataset, 'voxel_size_tea') and self.model_cfg.get(
                    'IS_TEACHER', None)
                else self.dataset.voxel_size),

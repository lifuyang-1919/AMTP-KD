...
class KDHeadTemplate(object):
    def __init__(self, model_cfg, dense_head):
        ...
        self.roi_head = None
        self.teacher_topk_channel_idx2 = None
    ...
    def align_feature_map(self, feature_tea, feature_stu, align_cfg, feature_tea2):
        """
        Args:
        ...
        elif target == 'teacher2':  # --tea_2
            output_shape = feature_tea2.shape
            self.teacher_topk_channel_idx = self.teacher_topk_channel_idx2
        else:
